...
class MotorSpeedsStamped {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MotorSpeedsStamped(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MotorSpeedsStamped(null);
...
module.exports = MotorSpeedsStamped;
